...
class StorageRoom(commands.Cog):
    ...
    async def cog_load(self):
        engine = create_engine(Config.DATABASE_CONNECTION, echo=True)
    ...
    async def list(self, ctx):
        """
        Show a list of games in the Vault.
        :param ctx:
        :return:
        """
        raise NotImplemented()

    async def info(self, ctx, codename):
        """
        Show details about a specific game in the Vault.
        :param ctx:
        :return:
        """
        raise NotImplemented()
    ...
    async def status(self, ctx):
        """
        Check the magical (and highly caffeinated) security status of the vault.
        :param ctx:
        :return:
        """
        raise NotImplemented()
